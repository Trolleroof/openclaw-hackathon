...
class TrainingEnvIdTests(unittest.TestCase):
    def test_train_and_eval_with_apollolabs_env_id(self):
        run_id = "apollolabs_env_id_unittest"
        ...
        model_path = train_policy(
            run_id=run_id,
            env_id="ApolloLabs/ObstacleAvoidanceEasy-v0",
        ...
        self.assertEqual(config["env_id"], "ApolloLabs/ObstacleAvoidanceEasy-v0")
